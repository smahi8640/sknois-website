...
class IonAuth
{
	...
	public function isMember(int $id=0): bool
	{
		$this->ionAuthModel->triggerEvents('is_member');

		$memberGroup = $this->config->memberGroup;

		return $this->loggedIn() && $this->ionAuthModel->inGroup($memberGroup, $id);
	}
	/**
