  ...
  if(!empty($products)) { ?>
    <?php foreach($products AS $record) { 
      ...
      $arrmerge= array_merge($arr1,$arr2,$arr3,$arr4,$arr5,$arr6);
        ...
        if(@$stock){
        $arrmerge = array_filter($arrmerge, function ($value) {

            return ($value["stock"] >= 1);
        
        });    
        }
    
      $price = array_column($arrmerge, 'price');
      array_multisort($price, SORT_ASC, $arrmerge);*/
        ...
        <div class="product__item">
            <div class="product__head">
                <div class="product__img">
                    <a href="<?php echo BASE ?>products/<?php echo $record['alias'].'-'.$record['style_no']; ?>">
						<?php 
            ...
            <div class="product__content justify-content-center align-items-center">
                ...
                <div class="product__name">
                    <h4 class="name"><a href="<?php echo BASE.'products/'.$record['alias'].'-'.$record['style_no']; ?>"><?php echo $record['title']; ?></a></h4>
                    <h4><?php echo nl2br($record['product_short_description']); ?></h4>
                </div>
            ...
            <div class="price d-flex justify-content-center align-items-center">
                    ...
                    if($record['price_default']!='price_default'){        
