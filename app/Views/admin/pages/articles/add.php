...
<?php $this->db = \Config\Database::connect();?>
    ...
    <form action="<?php echo base_url(''); ?>/admin/articles" id="save-form" class="records-list-form formvalidate" method="post" accept-charset="utf-8">
    <div class="card">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group-append">
                        <a href="<?php echo base_url('assets/admin/'); ?>filemanager/dialog.php?type=1&amp;field_id=image&amp;relative_url=1" data-fancybox-type="iframe" class="btn btn-white iframe-btn" type="button">Select</a>
                    </div>
                    <div class="uploaded_images input-group-append">
                        <?php 
                            if(!empty(@$record->image)){
                                
                                    echo '<div class="uploaded_image_ele"><img id="image-preview" style="max-height:80px;max-width:80px;" src="'.base_url('media/source/'.@$record->image).'"  data-attr="'.@$record->id.'" class="uploaded_image"></div>';   
	    		...
	    		success(response){
	    			...
	    			$("#mab1").hide();
                      ...
                      Toast.fire({
                        ...
                        window.location = "<?php echo base_url().'/admin/articles'?>";
                    });
