...
<?php $this->db = \Config\Database::connect();?>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <a href="<?php echo site_url('admin/articles/view');?>" class="btn btn-success">New</a>
        ...
        <div class="card-body">
            ...
            <?php $i = 1; foreach($records as $data) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url('admin/articles/view/').$data->id;?>" ><?php echo $data->title; ?></a></td>

                    <td class="text-center">
                        <a href="<?php echo site_url('admin/articles/view/').$data->id;?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
  ...
  var Toast = Swal.mixin({
    ...
    swal({
      ...
      dangerMode: true,
        ...
        if (willDelete) {
            $.ajax({
                url:'<?php echo base_url().'/admin/articles/delete'?>',
                method:"POST",
                data:{id:id},
                beforeSend: function(){
                  $("#mab1").show();          
