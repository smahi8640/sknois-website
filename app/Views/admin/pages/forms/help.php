                    ...
                    <div class="modal-body">
                       <div class="row">
                           <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="fullname" placeholder="Full Name"  id="fullname" value="<?php echo $data->fullname; ?>"> 
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                <label for="c-name">Query :</label>
                                <textarea class="form-control" name="query" placeholder="Query"  id="query"><?php echo $data->query; ?> </textarea>
                            </div>
                        </div>
                    </div>
  ...
  var Toast = Swal.mixin({
    ...
    swal({
      ...
      dangerMode: true,
        ...
        if (willDelete) {
            $.ajax({
                url:'<?php echo base_url().'admin1/forms/delete_help'?>',
                method:"POST",
                data:{id:id},
                beforeSend: function(){
                  $("#mab1").show();          
                ...
                if(obj.status=="1"){
                  ...
                  Toast.fire({
                    ...
                    window.location = "<?php echo base_url().'admin1/forms/help'?>";
                });
