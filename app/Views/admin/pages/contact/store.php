...
<div class="wrapper">
    ...
    <form action="#" id="records-list-form" class="records-list-form" method="post" accept-charset="utf-8">
    ...
    <div class="card">
        <div class="card-header">
            <!--<h3 class="card-title">
                <a href="<?php //echo base_url('admin/news/view');?>" class="btn btn-success">New</a>
    ...
    <?php $i = 1; foreach($records as $data) { 
        $stores=json_decode($data['store_details']);
        //print_r($stores->id);
    ?>
    <!-- Enquire Popup -->
					...
					<form id="sendenquiry" method="POST">
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
								<label >Store Name :</label> <?= $stores->name; ?> 
							</div>
						    <div class="form-group col-md-12">
								<label>State :  </label> <?= $stores->state; ?>
							</div>
							<div class="form-group col-md-12">
								<label>City :  </label> <?= $stores->city; ?>
							</div>
							<div class="form-group col-md-12">
								<label>Date Time :  </label> <?= date('d-m-Y h:i:s a', strtotime($stores->datetime)); ?>
							</div>
            ...
            $.ajax({
                ...
                if(obj.status=="1"){
                  ...
                  Toast.fire({
                    ...
                    window.location = "<?php echo base_url().'/admin/enquiry/store'?>";
                });
