...
<div class="wrapper">
 ...
 <?php require_once(APPPATH.'views/admin1/partial/title.php'); ?>
    ...
    <form action="<?php echo base_url(''); ?>admin1/orderstatus" id="records-list-form" class="records-list-form" method="post" accept-charset="utf-8">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <a href="<?php echo site_url('admin1/orderstatus/view');?>" class="btn btn-success">New</a>
                ...
                <table id="example2" class="table table-bordered table-hover datalist-table" >
	              ...
	              <tbody>
	                ...
	                <tr>
	                  ...
	                  <td class="text-center">
                            <a href="<?php echo site_url('admin1/orderstatus/view/').$data->id;?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
  ...
  var Toast = Swal.mixin({
    ...
    swal({
      ...
      dangerMode: true,
        ...
        if (willDelete) {
            $.ajax({
                url:'<?php echo base_url().'admin1/orderstatus/delete'?>',
                method:"POST",
                data:{id:id},
                beforeSend: function(){
                  $("#mab1").show();          
