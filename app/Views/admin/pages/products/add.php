...
<div class="overlay" id="mab1" style="display:none; height:280%" ><i class="fas fa-3x fa-sync-alt fa-spin"></i></div>
<div class="wrapper">
...
<?php $this->db = \Config\Database::connect();?>
 <form action="<?php echo base_url(''); ?>admin/products" id="save-form" class="records-list-form formvalidate" method="post" accept-charset="utf-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label for="c-name">Style No :</label>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote" name="description" id="summernote"  ><?php echo @$record->description;?></textarea>
                        </div>
                        ...
                        <div class="form-group col-md-4 ">
                            ...
                            <select class="select2" data-dropdown-css-class="select2-purple" name="category_ids[]" multiple="multiple" required data-placeholder="Select Category" style="width: 100%;">
                                <?php 
                        ...
                        <div class="form-group col-md-4 ">
                            <label for="c-name">Related Products :</label>
                            <div class="select2-purple">
                            <select class="select2" data-dropdown-css-class="select2-purple" name="related_product_ids[]" multiple="multiple" data-placeholder="Select Related Products" style="width: 100%;">
                                <?php 
                        ...
                        <div class="form-group col-md-4 d-none">
                            ...
                            <input type="number" class="form-control" name="product_price" placeholder="MRP" required value="0">
                        </div>
                        
                        <div class="form-group col-md-4 d-none">
                            <label for="c-name">Final Price :</label>
                            <input type="number" class="form-control" name="product_final_price" placeholder="Final Price" required value="0">
                        </div>
                    ...
                    ?>
                        ...
                        ?>
                            <div class="form-group col-md-4">
                                ...
                                <label for="c-name">Video White :</label>
                                <div class="input-group">
                                    <input class="form-control image_path col-md-9" id="video_white" name="video_white"  value="<?php echo @$video_white; ?>" placeholder="Image"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                    <label for="c-name">White Image :</label>
                                    <div class="input-group">   
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                  <input class="form-control image_path" id="yellow_image" name="yellow_image" value="<?php echo @$record->yellow_image?>" placeholder="Image"/>
                                  <div class="input-group-append">
                                  ...
                                  <input class="form-control image_path" id="yellow_zoom" name="yellow_zoom" value="<?= (@$record->yellow_zoom)?@$record->yellow_zoom:@$record->yellow_image ?>" placeholder="Zoom Image"/>
                                  <div class="input-group-append">
                                      <a href="<?php echo base_url('assets/filemanager/dialog.php?type=1&field_id=yellow_zoom&relative_url=1'); ?>" data-fancybox-type="iframe" class="btn btn-default iframe-btn" type="button">Select</a>
                                  </div>
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">     
                                  <input class="form-control image_path" id="pink_image" name="pink_image" value="<?php echo @$record->pink_image?>" placeholder="Image"/>
                                  <div class="input-group-append">
                                  ...
                                  <input class="form-control image_path" id="pink_zoom" name="pink_zoom" value="<?= (@$record->pink_zoom)?@$record->pink_zoom:@$record->pink_image ?>" placeholder="Zoom Image"/>
                                  <div class="input-group-append">
                                      <a href="<?php echo base_url('assets/filemanager/dialog.php?type=1&field_id=pink_zoom&relative_url=1'); ?>" data-fancybox-type="iframe" class="btn btn-default iframe-btn" type="button">Select</a>
                                  </div>
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div  class="form-group col-md-4">
                              <label for="white_multi_image">White Product Images</label>																								
                                  ...
                                  <?php if(!empty($white_multi_image)) { ?>
                                    ...
                                    <div class="white_multi_image_list-container">
                                      <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="white_multi_zoom[]" value="<?= (@$white_multi_img->zoom)?@$white_multi_img->zoom:@$white_multi_img->image ?>"  id="white_multi_zoom<?php echo $i; ?>" class="form-control" placeholder="Image Zoom" />
                                  ...
                                  <?php }else{ 
                                    ...
                                    <div class="white_multi_image_list-container">
                                      <div class="input-group mb-2">                                     
                                        ...
                                        <input type="text" name="white_multi_zoom[]" value=""  id="white_multi_zoom<?php echo $j; ?>" class="form-control" placeholder="Image Zoom" />
                                  ...
                                  <?php if(!empty($yellow_multi_image)) { ?>
                                    ...
                                    <div class="yellow_multi_image_list-container">
                                      <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="yellow_multi_image[]" value="<?php echo $yellow_multi_img->image; ?>"  id="yellow_multi_imageID<?php echo $i; ?>" class="form-control" placeholder="Image"/>
                                        <input type="text" name="yellow_multi_zoom[]" value="<?= (@$yellow_multi_img->zoom)?@$yellow_multi_img->zoom:@$yellow_multi_img->image ?>"  id="yellow_multi_zoomID<?php echo $i; ?>" class="form-control" placeholder="Image Zoom" />
                                    ...
                                    <div class="yellow_multi_image_list-container">
                                      <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="yellow_multi_image[]" value=""  id="yellow_multi_imageID<?php echo $j; ?>" class="form-control" placeholder="Image" />
                                        <input type="text" name="yellow_multi_zoom[]" value=""  id="yellow_multi_zoomID<?php echo $j; ?>" class="form-control" placeholder="Image Zoom"/>
                                  ...
                                  <?php if(!empty($pink_multi_image)) { ?>
                                    ...
                                    <div class="pink_multi_image_list-container">
                                      <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="pink_multi_zoom[]" value="<?= (@$pink_multi_img->zoom)?@$pink_multi_img->zoom:@$pink_multi_img->image ?>"  id="pink_multi_zoomID<?php echo $i; ?>" class="form-control" placeholder="Image Zoom" />
                                    ...
                                    <div class="pink_multi_image_list-container">
                                      <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="pink_multi_image[]" value=""  id="pink_multi_imageID<?php echo $j; ?>" class="form-control" placeholder="Image"/>
                                        <input type="text" name="pink_multi_zoom[]" value=""  id="pink_multi_zoomID<?php echo $j; ?>" class="form-control" placeholder="Image Zoom"/>
...
<div class="card">
    <div class="card-header">
         ...
         <div class="col-md-5">
            ...
            <form id="uploadstock" method="post" accept-charset="utf-8" >
            <input type="file" name="file1" id="file1">
            <input type="hidden" value="<?= @$record->id?>" name="id"/>
            <button type="submit"  class="btn btn-warning"><i class="fa fa-save"></i> Upload Stock</buttton>
            </form>
          </div>  
          <div class="col-md-3">
...
<script>
        ...
        if(field_id == 'white_multi_image_list'){
            ...
            if(x < media_max_fields){
                ...
                if(is_json){
                        ...
                        if(x < media_max_fields){
                            ...
                            var white_multi_image_list_html  = '<div class="white_multi_image_list-container">';
                                white_multi_image_list_html  = '<div class="input-group mb-2">';
                                    ...
                                    white_multi_image_list_html += '<input name="white_multi_zoom[]" value="'+obj[i]+'" id="white_multi_zoomID'+x+'" class="form-control" type="text" placeholder="Image Zoom">';
                    ...
                    var white_multi_image_list_html  = '<div class="white_multi_image_list-container">';
                        white_multi_image_list_html  = '<div class="input-group mb-2">';
                            white_multi_image_list_html += '<input name="white_multi_image[]" value="'+images+'" id="white_multi_imageID'+x+'" class="form-control" type="text" placeholder="Image Zoom">';
                            white_multi_image_list_html += '<input name="white_multi_zoom[]" value="'+images+'" id="white_multi_zoomID'+x+'" class="form-control" type="text" placeholder="Image Zoom">';
                            white_multi_image_list_html += '<input name="white_disp_order[]" value="'+x+'" id="white_orderID'+x+'" class="form-control" type="number">';
                            white_multi_image_list_html += '<span class="input-group-btn">';
                              white_multi_image_list_html += '<a href="#" class="btn btn-danger remove_field"><i class="fas fa-times" aria-hidden="true"></i></a>';
                            white_multi_image_list_html += '</span>';
        ...
        if(field_id == 'yellow_multi_image_list'){
            if(x1 < media_max_fields1){
                ...
                if(is_json){
                        ...
                        if(x1 < media_max_fields1){
                            ...
                            var yellow_multi_image_list_html1  = '<div class="yellow_multi_image_list-container">';
                                yellow_multi_image_list_html1  = '<div class="input-group mb-2">';
                                    yellow_multi_image_list_html1 += '<input name="yellow_multi_image[]" value="'+obj[i]+'" id="yellow_multi_imageID'+x1+'" class="form-control" type="text" placeholder="Image">';
                                    yellow_multi_image_list_html += '<input name="yellow_multi_zoom[]" value="'+obj[i]+'" id="yellow_multi_zoomID'+x+'" class="form-control" type="text" placeholder="Image Zoom">';
                    ...
                    var yellow_multi_image_list_html1  = '<div class="yellow_multi_image_list-container">';
                        yellow_multi_image_list_html1  = '<div class="input-group mb-2">';
                            yellow_multi_image_list_html1 += '<input name="yellow_multi_image[]" value="'+images+'" id="yellow_multi_imageID'+x1+'" class="form-control" type="text"placeholder="Image">';
                            yellow_multi_image_list_html1 += '<input name="yellow_multi_image[]" value="'+images+'" id="yellow_multi_imageID'+x1+'" class="form-control" type="text" placeholder="Image Zoom">';
                            yellow_multi_image_list_html1 += '<input name="yellow_disp_order[]" value="'+x+'" id="yellow_orderID'+x+'" class="form-control" type="number">';
                            yellow_multi_image_list_html1 += '<span class="input-group-btn">';
                            yellow_multi_image_list_html1 += '<a href="#" class="btn btn-danger remove_field_yellow"><i class="fas fa-times" aria-hidden="true"></i></a>';
                            yellow_multi_image_list_html1 += '</span>';
        ...
        if(field_id == 'pink_multi_image_list'){
            if(x2 < media_max_fields2){
                ...
                if(is_json){
                        ...
                        if(x2 < media_max_fields2){
                            ...
                            var pink_multi_image_list_html2  = '<div class="pink_multi_image_list-container">';
                                pink_multi_image_list_html2  = '<div class="input-group mb-2">';
                                    pink_multi_image_list_html2 += '<input name="pink_multi_image[]" value="'+obj[i]+'" id="pink_multi_imageID'+x2+'" class="form-control" type="text" placeholder="Image">';
                                    pink_multi_image_list_html += '<input name="pink_multi_zoom[]" value="'+obj[i]+'" id="pink_multi_zoomID'+x+'" class="form-control" type="text" placeholder="Image Zoom">';
                    ...
                    var pink_multi_image_list_html2  = '<div class="pink_multi_image_list-container">';
                        pink_multi_image_list_html2  = '<div class="input-group mb-2">';
                            pink_multi_image_list_html2 += '<input name="pink_multi_image[]" value="'+images+'" id="pink_multi_imageID'+x2+'" class="form-control" type="text" placeholder="Image">';
                            pink_multi_image_list_html2 += '<input name="pink_multi_image[]" value="'+images+'" id="pink_multi_imageID'+x2+'" class="form-control" type="text" placeholder="Image Zoom">';
                            pink_multi_image_list_html2 += '<input name="pink_disp_order[]" value="'+x+'" id="pink_orderID'+x+'" class="form-control" type="number">';
                            pink_multi_image_list_html2 += '<span class="input-group-btn">';
                            pink_multi_image_list_html2 += '<a href="#" class="btn btn-danger remove_field_pink"><i class="fas fa-times" aria-hidden="true"></i></a>';
                            pink_multi_image_list_html2 += '</span>';
                ...
                if(obj.status=="1"){
                    setTimeout(function(){
                        Toast.fire({
                           ...
                           window.location = "<?php echo base_url().'/admin/products/edit/'?>"+obj.product_id;
                        });
                    },1000); 
    ...
    $(document).on("click","#save_india",function(){
        ...
        $("#stock-save-india1").each(function(){
            ...
            $.ajax({
            url:'<?php echo base_url().'/admin/products/updatestock'?>',
            method:"POST",
                ...
                if(obj.status=="1"){
                    setTimeout(function(){
                        Toast.fire({
                            ...
                            //window.location = "<?php echo base_url().'admin/products/view1/'?>"+obj.product_id;
                        });
                    },1000); 
                }*/
            }
    ...
    /*$(document).on("click","#withsize",function(){
        ...
        $.ajax({
            url:'<?php //echo base_url().'/admin/products/addstock'?>',
            method:"POST",
    ...
    $(document).on("click","#deletestock",function(){
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url:'<?php echo base_url().'/admin/products/deletestock'?>',
                    method:"POST",
                    data:{pid:pid},
                    beforeSend: function(){
                        $("#mab1").show();          
                        ...
                        if(obj.status=="1"){
                            setTimeout(function(){
                                Toast.fire({
                                    ...
                                    window.location = "<?php echo base_url().'admin/products/view/'?>"+obj.data;
                                });
                            },1000); 
                        }
                    }
    ...
    $(document).on("submit","#uploadstock",function(e){
        e.preventDefault();
            $.ajax({
            url:'<?php echo base_url().'/admin/products/import1'?>',
            method:"POST",
            data:new FormData(this),
            contentType: false,
            cache: false,
    ...
    $(document).on("submit","#withoutsize",function(e){
        e.preventDefault();
            $.ajax({
            url:'<?php echo base_url().'/admin/products/import1'?>',
            method:"POST",
    ...
    $(document).on("submit","#frm-add-product",function(e){
        ...
        $.ajax({
            url:'<?php echo base_url('admin/products/add_product_detail') ?>',
            method:"POST",
            data:formData,
            contentType: false,
            cache: false,
