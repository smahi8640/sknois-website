...
<div class="wrapper">
    ...
    <form action="<?php echo base_url(''); ?>admin/brands" id="records-list-form" class="records-list-form" method="post" accept-charset="utf-8">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mb-12">       
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <a href="<?php echo base_url('admin/brands/edit');?>" class="btn btn-success">New</a>
                            ...
                            <?php if(!empty($records)) { ?>
                                ...
                                <tbody>
                                    <?php $i = 1; foreach($records as $data) { ?>
                                        <tr>                                           
                                            <td>
                                                <a href="<?php echo base_url('admin/brands/edit/'.$data['id']) ;?>" ><?php echo $data['title']; ?></a>
                                                <small class="d-block">(Alias : <?php echo $data['alias']; ?>)</small>
                                            </td>
                                            
                                            <td class="text-center">
                                                <a href="<?php echo base_url('/admin/brands/edit/'.$data['id']);?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
  ...
  var Toast = Swal.mixin({
    ...
    swal({
      ...
      dangerMode: true,
        ...
        if (willDelete) {
            $.ajax({
                url:'<?php echo base_url().'/admin/brands/delete'?>',
                method:"POST",
                data:{id:id},
                beforeSend: function(){
                  $("#mab1").show();          
