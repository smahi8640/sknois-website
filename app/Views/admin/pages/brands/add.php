        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="description"  id="summernote" ><?php echo @$record->description?></textarea>
                </div>
                
                <div class="form-group col-md-4">
                    <label for="c-name">Image :</label>
                    <div class="input-group">
                      <input class="form-control image_path" id="image" name="image" value="<?php echo @$record->image?>"/>
                      ...
                      <div class="uploaded_images input-group-append">
                          ...
                          <?php if(!empty(@$record->images)) { ?>
                            <div class="uploaded_image_ele">
                              <img id="image-preview" style="max-height:80px;max-width:80px;" src="<?php echo base_url('media/source/'.@$record->images); ?>" data-attr="<?php echo  @$record->id; ?>" class="uploaded_image">
                            </div>
                          <?php } else { ?>
                ...
                <div class="form-group col-md-4">
                    <label for="c-name">Brochure :</label>
                    <div class="input-group">
                      <input class="form-control image_path" id="brochure" name="brochure" value="<?php echo @$record->brochure?>"/>
                      <div class="input-group-append">
                          <a href="<?php echo base_url('assets/filemanager/dialog.php?type=2&field_id=brochure&relative_url=1'); ?>" data-fancybox-type="iframe" class="btn btn-default iframe-btn" type="button">Select</a>
                      </div>
                    </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="display_order" placeholder="display_order"  value="<?php echo @$record->display_order?>"> 
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    <label for="c-name">Meta Tag :</label>
                    <input type="text" class="form-control" name="meta_tag" placeholder="Meta Tag"  value="<?php echo @$record->meta_tag?>"> 
                </div>
                
                <div class="form-group col-md-12">
                    <label for="c-name">Meta Description :</label>
                    <textarea class="form-control" name="meta_description" ><?php echo @$record->meta_description?></textarea>
                </div>
...
//Validation
 ...
 $(document).on("submit","#save-form",function(e){
	    	e.preventDefault();
	    	$.ajax({
	    		url:'<?php echo base_url('admin/brands/add') ?>',
	    		method:"POST",
	    		...
	    		success(response){
	    			...
	    			$("#mab1").hide();
                      ...
                      Toast.fire({
                        ...
                        window.location = "<?php echo base_url().'/admin/brands'?>";
                    });
